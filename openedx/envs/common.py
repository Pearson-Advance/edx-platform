...
# .. setting_name: LEARNING_SEQUENCES_OUTLINE_CACHE_TIMEOUT_SECONDS
# .. setting_default: 300
# .. setting_description: Number of seconds to cache course outline data generated by the
#   Learning Sequences API. This value can be overridden per site using Site Configuration
#   with the same key. The cached outline is not user-specific.
LEARNING_SEQUENCES_OUTLINE_CACHE_TIMEOUT_SECONDS = 300
