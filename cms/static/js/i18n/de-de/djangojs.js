...
'use strict';
{
  ...
  const newcatalog = {
    ...
    " redirect the user to the next page": " leitet den Benutzer auf die n\u00e4chste Seite um",
    ...
    "(contains %(student_count)s student)": [
      "(enth\u00e4lt %(student_count)s Student)",
      "(enth\u00e4lt %(student_count)s Studenten)"
    ],
    "(optional)": "(optional)",
    "(required)": "(*)",
    ...
    "Certificate exceptions group selection": "Auswahl der Zertifikatsausnahmegruppe",
    ...
    "Click to change": "Klicke zum \u00c4ndern",
    "Click to choose all %s at once.": "Klicken, um alle %s auf einmal auszuw\u00e4hlen.",
    "Click to copy link to clipboard": "Klicken Sie, um den Link in die Zwischenablage zu kopieren",
    ...
    "Copy Unit": "Kopiereinheit",
    "Copy link": "Link kopieren",
    "Copy of \"{componentDisplayName}\"": "Kopie von &quot; {componentDisplayName} &quot;",
    ...
    "Discussions enabled": "Diskussionen aktiviert",
    "Dismiss": "Tour Beenden",
    ...
    "Editor": "Editor",
    "Edits made here will only be reflected in this course. These edits may be overridden later if updates are accepted.": "Hier vorgenommene \u00c4nderungen wirken sich nur auf diesen Kurs aus. Diese \u00c4nderungen k\u00f6nnen sp\u00e4ter \u00fcberschrieben werden, wenn Aktualisierungen akzeptiert werden.",
    "Eligible": "Berechtigt",
    "Email": "E-Mail",
    "Email address": "Email-Adresse",
    "Email was sent to the following users. They will be allowed to enroll once they register:": "Die E-Mail wurde an folgende Benutzer gesendet. Sie k\u00f6nnen nach registrieren einschreiben :",
    "Email was sent to the following users. They will be enrolled once they register:": "E-Mail wurde an die folgenden Benutzer gesendet. Sie werden eingeschrieben , sobald Sie registrieren :",
    ...
    "Embed your subsection content directly on a page using an iframe, and view it without the LMS header and footer.": "Betten Sie Ihren Unterabschnittsinhalt mithilfe eines Iframes direkt in eine Seite ein und zeigen Sie ihn ohne LMS-Kopf- und Fu\u00dfzeile an.",
    "Emoticons": "Emoticons",
    "Enable": "aktivieren",
    ...
    "Enable discussion": "Diskussion erm\u00f6glichen",
    "Enable summaries": "Zusammenfassungen aktivieren",
    "Enabled": "Aktiviert",
    "Encoding": "Kodiere",
    ...
    "Error": "Fehler",
    "Error Ending Exam": "Fehler beim Beenden der Pr\u00fcfung",
    "Error Starting Exam": "Fehler beim Starten der Pr\u00fcfung",
    ...
    "Error generating list of inactive students who are enrolled in a course. Please try again.": "Fehler beim Generieren der Liste inaktiver Studierender, die in einen Kurs eingeschrieben sind. Bitte versuchen Sie es erneut.",
    ...
    "Explore new programs": "Entdecken Sie neue Programme",
    ...
    "Hidden in the course outline, but sections are accessible for your learners through their separate link.": "In der Kurs\u00fcbersicht ausgeblendet, aber die Abschnitte sind f\u00fcr Ihre Lernenden \u00fcber einen separaten Link zug\u00e4nglich.",
    "Hide": "Ausblenden",
    ...
    "Hide in Course Outline, accessible via Link": "In Kurs\u00fcbersicht ausblenden, zug\u00e4nglich \u00fcber Link",
    ...
    "If a learner starts on {startDate}, this subsection will be due on {projectedDueIn}.": "Wenn ein Lernender am {startDate} beginnt, ist dieser Unterabschnitt am {projectedDueIn} f\u00e4llig.",
    ...
    "If you make this section visible in the table of content, learners will be able to see its content.": "Wenn Sie diesen Abschnitt im Inhaltsverzeichnis sichtbar machen, k\u00f6nnen Lernende seinen Inhalt sehen.",
    ...
    "Ignore these changes?": "Diese \u00c4nderungen ignorieren?",
    "Image": "Bild",
    ...
    "It is intentionally hidden from learners, ensuring that only the course staff can view its contents.": "Es wird absichtlich vor den Lernenden verborgen, um sicherzustellen, dass nur das Kurspersonal seine Inhalte sehen kann.",
    "It is intentionally hidden from standard navigation, ensuring that only individuals with the link can view its contents.": "Es wird absichtlich in der Standardnavigation ausgeblendet, um sicherzustellen, dass nur Personen, die \u00fcber den Link verf\u00fcgen, seinen Inhalt sehen k\u00f6nnen.",
    ...
    "It is visible to learners, ensuring that all learners can view its contents.": "Es ist f\u00fcr Lernende sichtbar und stellt sicher, dass alle Lernenden den Inhalt sehen k\u00f6nnen.",
    "Italic": "Kursiv",
    ...
    "Learners do not see question-level correctness or scores before or after the due date. However, once the due date passes, they can see their overall score for the subsection on the Progress page.": "Lernende sehen die Richtigkeit auf Fragenebene oder die Punktzahlen weder vor noch nach dem F\u00e4lligkeitsdatum. Sobald das F\u00e4lligkeitsdatum jedoch verstrichen ist, k\u00f6nnen sie ihre Gesamtpunktzahl f\u00fcr den Unterabschnitt auf der Fortschrittsseite einsehen.",
    ...
    "Load next {num_items} result": [
      "N\u00e4chstes {num_items} -Ergebnis laden",
      "N\u00e4chste {num_items} -Ergebnisse laden"
    ],
    "Loading": "Ladevorgang",
    ...
    "Migrating to Problem Bank": "Migration zur Aufgabenbank",
    ...
    "Never show individual assessment results, but show overall assessment results after due date": "Zeigen Sie niemals individuelle Bewertungsergebnisse an, sondern zeigen Sie die Gesamtergebnisse nach dem F\u00e4lligkeitsdatum an.",
    "New %(item_type)s": "%(item_type)s erstellen",
    "New Address": "Neue Adresse",
    "New Password": "Neues Passwort",
    "New document": "Neues Dokument",
    "New enrollment mode:": "Neuer Einschreibungsmodus:",
    "New file(s) added to Files & Uploads.": "Neue Datei(en) zu \u201eDateien &amp; Uploads\u201c hinzugef\u00fcgt.",
    ...
    "Paste": "Einf\u00fcgen",
    "Paste %(xblock_type)s": "F\u00fcgen Sie %(xblock_type)s ein",
    ...
    "Please enable discussions for graded units from the": "Bitte aktivieren Sie Diskussionen f\u00fcr benotete Einheiten aus dem",
    ...
    "Preview changes to: {title}": "Vorschau \u00e4ndert sich an: {title}",
    ...
    "Proctored exams are timed and they record video of each learner taking the exam. The videos are then reviewed to ensure that learners follow all examination rules. Please note that setting this exam as proctored will change the visibility settings to \"Hide content after due date.\"": "Beaufsichtigte Pr\u00fcfungen sind zeitgesteuert und sie zeichnen Videos von jedem Lernenden auf, der die Pr\u00fcfung ablegt. Die Videos werden dann \u00fcberpr\u00fcft, um sicherzustellen, dass die Lernenden alle Pr\u00fcfungsregeln befolgen. Bitte beachten Sie, dass durch das Festlegen dieser Pr\u00fcfung als beaufsichtigt die Sichtbarkeitseinstellungen auf \u201eInhalte nach F\u00e4lligkeitsdatum ausblenden\u201c ge\u00e4ndert werden.",
    ...
    "Ready to submit": "Fertig zum Abschicken",
    "Reason": "Grund",
    ...
    "Share {display_name} subsection": "Teilen Sie den Unterabschnitt {display_name}",
    ...
    "Showing first response": [
      "Erste Antwort wird angezeigt",
      "Erste {numResponses} -Antworten werden angezeigt"
    ],
    ...
    "Some errors occurred": "Es sind einige Fehler aufgetreten",
    "Some images in this post have been omitted": "Einige Bilder dieses Beitrag's wurden weggelassen.",
    "Something has gone wrong ending your exam. Please double-check that the application is running.": "Beim Beenden Ihrer Pr\u00fcfung ist etwas schief gelaufen. Bitte \u00fcberpr\u00fcfen Sie noch einmal, ob die Anwendung ausgef\u00fchrt wird.",
    "Something has gone wrong ending your exam. Please reload the page and start again.": "Beim Beenden Ihrer Pr\u00fcfung ist etwas schief gelaufen. Bitte laden Sie die Seite neu und beginnen Sie erneut.",
    "Something has gone wrong starting your exam. Please double-check that the application is running.": "Beim Start Ihrer Pr\u00fcfung ist ein Fehler aufgetreten. Bitte \u00fcberpr\u00fcfen Sie noch einmal, ob die Anwendung ausgef\u00fchrt wird.",
    "Something has gone wrong starting your exam. Please reload the page and start again.": "Beim Start Ihrer Pr\u00fcfung ist ein Fehler aufgetreten. Bitte laden Sie die Seite neu und beginnen Sie erneut.",
    ...
    "Subsections are not navigable between each other, they can only be accessed through their link.": "Unterabschnitte sind untereinander nicht navigierbar, sie k\u00f6nnen nur \u00fcber ihren Link aufgerufen werden.",
    ...
    "Successful completion of %(org)s %(program)s credential can be applied towards flexible, rigorous, and affordable masters degrees from the world\u2019s leading universities.": "Der erfolgreiche Abschluss des %(org)s %(program)s-Zertifikats kann f\u00fcr flexible, anspruchsvolle und erschwingliche Masterabschl\u00fcsse an den weltweit f\u00fchrenden Universit\u00e4ten angewendet werden.",
    ...
    "The following files already exist in this course but don't match the version used by the component you pasted:": "Die folgenden Dateien sind in diesem Kurs bereits vorhanden, stimmen jedoch nicht mit der Version \u00fcberein, die von der von Ihnen eingef\u00fcgten Komponente verwendet wird:",
    "The following information is already a part of your {platform} profile and is required for your application. To edit this information go to ": "Die folgenden Informationen sind bereits Teil Ihres {platform} Profils und werden f\u00fcr Ihre Anwendung ben\u00f6tigt. Um diese Informationen bearbeiten gehen Sie zu",
    ...
    "The following required files could not be added to the course:": "Die folgenden erforderlichen Dateien konnten dem Kurs nicht hinzugef\u00fcgt werden:",
    "The following required files were imported to this course:": "Die folgenden erforderlichen Dateien wurden in diesen Kurs importiert:",
    ...
    "The minimum number of weeks this subsection can be due in is 1 week from the learner enrollment date.": "Die Mindestanzahl von Wochen, in denen dieser Unterabschnitt f\u00e4llig sein kann, betr\u00e4gt 1 Woche ab dem Anmeldedatum des Lernenden.",
    ...
    "The number of {type} assignments defined here does not match the current number of {type} assignments in the course:": "Die hier definierte Anzahl der {type}-Aufgaben stimmt nicht mit der aktuellen Anzahl der {type}-Aufgaben im Kurs \u00fcberein:",
    "The number of {type} assignments in the course matches the number defined here.": "Die Anzahl der {type} Aufgaben im Kurs stimmt mit der hier definierten Anzahl \u00fcberein.",
    ...
    "There are no assignments of this type in the course.": "Es gibt keine Aufgaben dieser Art im Kurs.",
    ...
    "There was an error when trying to add learners:": [
      "Beim Versuch, Lernende hinzuzuf\u00fcgen, ist ein Fehler aufgetreten:",
      "{numErrors} Lernende konnten dieser Kohorte nicht hinzugef\u00fcgt werden:"
    ],
    ...
    "This field must not be blank": "Dieses Feld darf nicht leer sein",
    ...
    "This proctored exam has been released to learners. You may not convert it to another type of special exam. You may revert this subsection back to being a basic exam by selecting 'None', or a timed exam, but you will NOT be able to configure it as a proctored exam in the future.": "Diese beaufsichtigte Pr\u00fcfung wurde f\u00fcr Lernende freigegeben. Eine Umwandlung in eine andere Art von Sonderpr\u00fcfung ist nicht m\u00f6glich. Sie k\u00f6nnen diesen Unterabschnitt wieder in eine Basispr\u00fcfung zur\u00fcckverwandeln, indem Sie \u201eKeine\u201c oder eine zeitgesteuerte Pr\u00fcfung ausw\u00e4hlen, aber Sie k\u00f6nnen ihn in Zukunft NICHT mehr als beaufsichtigte Pr\u00fcfung konfigurieren.",
    ...
    "This subsection is configured as \\\"%(gradingType)s\\\", which doesn't exist in the current grading policy.": "Dieser Unterabschnitt ist als \u201e %(gradingType)s \u201c konfiguriert, was in der aktuellen Bewertungsrichtlinie nicht vorhanden ist.",
    "This subsection was released to learners as a proctored exam, but was reverted back to a basic or timed exam. You may not configure it as a proctored exam now. Contact edX Support for assistance.": "Dieser Unterabschnitt wurde den Lernenden als beaufsichtigte Pr\u00fcfung freigegeben, wurde jedoch wieder auf eine grundlegende oder zeitgesteuerte Pr\u00fcfung zur\u00fcckgesetzt. Sie k\u00f6nnen es jetzt nicht als beaufsichtigte Pr\u00fcfung konfigurieren. Wenden Sie sich an den edX-Support, um Unterst\u00fctzung zu erhalten.",
    ...
    "Time Multiplier": "Zeitmultiplikator",
    ...
    "To hide the subsections and keep them accesible through links, you must adjust it from the section that contains them.": "Um die Unterabschnitte auszublenden und sie \u00fcber Links zug\u00e4nglich zu halten, m\u00fcssen Sie sie in dem Abschnitt anpassen, der sie enth\u00e4lt.",
    ...
    "Transform your %(org)s %(type)s into a full master\u2019s degree": "Verwandeln Sie Ihren %(org)s %(type)s in einen vollst\u00e4ndigen Master-Abschluss",
    ...
    "Used in {count} location": [
      "Wird am Standort {count} verwendet",
      "Wird an {count} -Standorten verwendet"
    ],
    ...
    "What's in my clipboard?": "Was ist in meiner Zwischenablage?",
    ...
    "When sharing this link with your learners, they will see the content of the subsection along with the header and footer of your LMS.": "Wenn Sie diesen Link mit Ihren Lernenden teilen, sehen diese den Inhalt des Unterabschnitts zusammen mit der Kopf- und Fu\u00dfzeile Ihres LMS.",
    ...
    "Words: {0}": "W\u00f6rter: {0}",
    "Would you like to permanently ignore this updated version? If so, you won't be able to update this until a newer version is published (in the library).": "M\u00f6chten Sie diese aktualisierte Version dauerhaft ignorieren? In diesem Fall k\u00f6nnen Sie diese erst aktualisieren, wenn eine neuere Version (in der Bibliothek) ver\u00f6ffentlicht wird.",
    ...
    "Xpert unit summaries": "Zusammenfassungen der Xpert-Einheiten",
    ...
    "You are editing content from a Library.": "Sie bearbeiten Inhalt aus einer Bibliothek.",
    ...
    "You have access to the {enterpriseName} dashboard": "Sie haben Zugriff auf das Dashboard {enterpriseName}",
    ...
    "You have successfully completed all the requirements for the %(title)s %(type)s.": "Sie haben alle Anforderungen f\u00fcr %(title)s %(type)s erfolgreich erf\u00fcllt.",
    ...
    "You may also lose access to verified certificates and other program credentials. You can make a copy of these for your records before proceeding with deletion.": "Sie verlieren m\u00f6glicherweise auch den Zugriff auf verifizierte Zertifikate und andere Programmanmeldeinformationen. Sie k\u00f6nnen diese f\u00fcr Ihre Unterlagen kopieren, bevor Sie mit dem L\u00f6schen fortfahren.",
    ...
    "You may need to update a file(s) manually": "M\u00f6glicherweise m\u00fcssen Sie eine oder mehrere Dateien manuell aktualisieren",
    ...
    "You must have at least one undroppable <%- types %> assignment.": "Sie m\u00fcssen mindestens eine undroptable <%- types %>-Zuweisung haben.",
    ...
    "course mode param is not provided": "Kursmodus-Parameter ist nicht angegeben",
    "course mode param is provided": "Kursmodus-Parameter wird bereitgestellt",
    ...
    "query param next is internal": "Abfrageparameter \u201enext\u201c ist intern",
    "query param next is provide": "Der n\u00e4chste Abfrageparameter ist \u201eprovide\u201c.",
    ...
    "there is currently {numVotes} vote": [
      "Es gibt derzeit {numVotes} Abstimmung",
      "Es gibt derzeit {numVotes} Stimmen"
    ],
    ...
    "weeks from learner enrollment date": "Wochen ab dem Anmeldedatum des Lernenden",
    ...
    "{assignment_count} {type} assignment(s) found:": "{assignment_count} {type} Aufgabe(n) gefunden:",
    ...
    "{numMoved} learner was moved from {prevCohort}": [
      "{numMoved} Lernender wurde von {prevCohort} verschoben",
      "{numMoved} Lernende wurden von {prevCohort} verschoben"
    ],
    "{numPreassigned} learner was pre-assigned for this cohort. This learner will automatically be added to the cohort when they enroll in the course.": [
      "Der {numPreassigned} -Lernende wurde dieser Kohorte vorab zugewiesen. Dieser Lernende wird automatisch zur Kohorte hinzugef\u00fcgt, wenn er sich f\u00fcr den Kurs anmeldet.",
      "{numPreassigned} Lernende wurden dieser Kohorte vorab zugewiesen. Diese Lernenden werden automatisch zur Kohorte hinzugef\u00fcgt, wenn sie sich f\u00fcr den Kurs anmelden."
    ],
    "{numPresent} learner was already in the cohort": [
      "Der {numPresent} Lernende war bereits in der Kohorte",
      "{numPresent} Lernende waren bereits in der Kohorte"
    ],
    ...
    "{numUsersAdded} learner has been added to this cohort. ": [
      "{numUsersAdded} Lernender wurde dieser Kohorte hinzugef\u00fcgt. ",
      "{numUsersAdded} Lernende wurden dieser Kohorte hinzugef\u00fcgt. "
    ],
    "{numVotes} Vote": [
      "{numVotes} Abstimmung",
      "{numVotes} Stimmen"
    ...
    "{num_points} point possible (graded, results hidden)": [
      "{num_points} Punkt m\u00f6glich (benotet, Ergebnisse ausgeblendet)",
      "{num_points} Punkte m\u00f6glich (bewertet, Ergebnisse ausgeblendet)"
    ],
    ...
    "{num_points} point possible (ungraded, results hidden)": [
      "{num_points} Punkt m\u00f6glich (unbewertet, Ergebnisse ausgeblendet)",
      "{num_points} Punkte m\u00f6glich (unbewertet, Ergebnisse ausgeblendet)"
    ],
