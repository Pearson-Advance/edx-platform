...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "\n            Do not close this window before you finish your exam. if you close this window, your proctoring session ends, and you will not successfully complete the proctored exam.\n          ": "\nNo cerrar esta ventana antes de terminar su examen. Si la cierra, su sesi\u00f3n de supervisi\u00f3n finaliza y no completar\u00e1 con \u00e9xito el examen supervisado.",
    ...
    "\n            Return to the %(platform_name)s course window to start your exam. When you have finished your exam and\n            have marked it as complete, you can close this window to end the proctoring session\n            and upload your proctoring session data for review.\n          ": "\nRegresar a la ventana del curso %(platform_name)s para comenzar su examen. Cuando haya terminado su examen y lo haya marcado como completo, puede cerrar esta ventana para finalizar la sesi\u00f3n de supervisi\u00f3n y cargar los datos de la sesi\u00f3n de supervisi\u00f3n para su revisi\u00f3n.",
    ...
    "\n          Step 2\n        ": "\n          Paso 2\n        ",
    "\n          Step 3\n        ": "\n          Paso 3\n        ",
    "\n          You will be guided through steps to set up online proctoring software and verify your identity.\n        ": "\nSe lo guiar\u00e1 a trav\u00e9s de los pasos para configurar el software de supervisi\u00f3n en l\u00ednea y verificar su identidad.",
    ...
    "\n        Get familiar with proctoring for real exams later in the course. This practice exam has no impact\n        on your grade in the course.\n      ": "\nFamiliarizate con la supervisi\u00f3n de ex\u00e1menes reales m\u00e1s adelante en el curso. Este examen de pr\u00e1ctica no tiene impacto en su calificaci\u00f3n en el curso.",
    "\n        Hello %(username)s,\n    ": "\n        Hola %(username)s,\n    ",
    ...
    "\n        If you take this exam without proctoring, you will not be eligible for course credit or the MicroMasters credential if either applies to this course.\n      ": "\nSi realiza este examen sin supervisi\u00f3n, no ser\u00e1 considerado apto para el cr\u00e9dito del curso o la credencial de MicroMasters si se aplica a este curso.",
    "\n        Make sure you:\n      ": "\nAseg\u00farese:",
    ...
    "\n        Select the exam code, then copy it using Control + C (Windows) or Command + C (Mac).\n      ": "\nSeleccionar el c\u00f3digo del examen, luego c\u00f3pielo usando Control + C (Windows) o Comando + C (Mac).",
    "\n        Start your system check now. A new window will open for this step and you will verify your identity.\n      ": "\nIniciar la comprobaci\u00f3n de su sistema ahora. Se abrir\u00e1 una nueva ventana para este paso y verificar\u00e1 su identidad.",
    ...
    "\n        To be eligible for credit or the program credential associated with this course, you must pass the proctoring review for this exam.\n    ": "\nPara ser considerado apto para el cr\u00e9dito o la credencial del programa asociado con este curso, debe aprobar la revisi\u00f3n de supervisi\u00f3n para este examen.",
    "\n        Try a proctored exam\n      ": "\nIntentar tomar un examen supervisado",
    ...
    "\n      Please complete an onboarding exam before attempting this exam.\n    ": "\nPor favor, completar un examen de incorporaci\u00f3n antes de intentar este examen.",
    ...
    "\n    Your onboarding exam is being reviewed. Before attempting this exam, please allow 2+ business days for your onboarding exam to be reviewed.\n  ": "\nSu examen de incorporaci\u00f3n est\u00e1 siendo revisado. Antes de intentar este examen, espere m\u00e1s de 2 d\u00edas h\u00e1biles para que se revise su examen de incorporaci\u00f3n.",
    ...
    "\n    Your proctoring session ended before you completed this onboarding exam.\n    You should retry this onboarding exam.\n  ": "\nSu sesi\u00f3n de supervisi\u00f3n finaliz\u00f3 antes de completar este examen de incorporaci\u00f3n. Debe volver a intentar este examen de incorporaci\u00f3n.",
    ...
    " Your Proctoring Session Has Started ": "Su sesi\u00f3n supervisada comenz\u00f3",
    ...
    "Choose %s by selecting them and then select the \"Choose\" arrow button.": "Elija %s seleccion\u00e1ndolos/as y luego use el bot\u00f3n flecha \"Elegir\".",
    "Choose a Date": "Seleccione una Fecha",
    "Choose a Time": "Seleccione una Hora",
    "Choose a time": "Elija una hora",
    "Choose all %s": "Elegir todo/as los/as %s",
    "Choose selected %s": "Elegir %s seleccionados/as",
    ...
    "Ending Exam": "Terminando el examen",
    ...
    "Have your valid photo ID (e.g. driver's license or passport) ready": "Tener lista la identificaci\u00f3n con foto v\u00e1lida (por ejemplo, licencia de conducir o pasaporte)",
    "Heading 3": "T\u00edtulo 3",
    "Heading 4": "T\u00edtulo 4",
    "Heading 5": "T\u00edtulo 5",
    "Heading 6": "T\u00edtulo 6",
    ...
    "I understand and want to reset this onboarding exam.": "Entiendo y quiero restablecer este examen de ingreso.",
    ...
    "Refresh": "Actualizar",
    "Rejected": "Rechazado",
    "Remove %s by selecting them and then select the \"Remove\" arrow button.": "Eliminar %s seleccion\u00e1ndolos/as y luego use el bot\u00f3n flecha \"Eliminar\".",
    "Remove all %s": "Eliminar todo/as los/as %s",
    "Remove selected %s": "Eliminar %s seleccionados/as",
    "Resetting Onboarding Exam": "Reiniciar el examen de ingreso",
    "Resumed": "reanudado",
    ...
    "Start System Check": "Comenzar con la verificaci\u00f3n del sistema",
    "Start my exam": "Empezar el examen",
    "Started": "Iniciado",
    ...
    "Type into this box to filter down the list of selected %s.": "Escriba en este cuadro para filtrar la lista de %s seleccionados/as.",
    ...
    "an onboarding exam": "un examen de ingreso",
