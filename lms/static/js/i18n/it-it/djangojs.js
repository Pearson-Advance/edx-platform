...
'use strict';
{
  ...
  const newcatalog = {
    ...
    " redirect the user to the next page": " Reindirizza l&#39;utente alla pagina successiva.",
    ...
    "Add Multiplier as a Number Greater Than 1": "Aggiungi moltiplicatore come numero maggiore di 1",
    "Add New Component": "Aggiungi nuovo componente",
    "Add Policy Exception": "Aggiungi eccezione alla policy",
    "Add Thumbnail": "Aggiungi miniatura",
    "Add Thumbnail - {videoName}": "Aggiungi miniatura - {videoName}",
    "Add Time(Minutes)": "Aggiungi tempo (minuti)",
    ...
    "Add library content": "Aggiungi contenuto della libreria",
    "Add notes about this learner": "Aggiungi note su questo studente ",
    "Add selected components": "Aggiungi componenti selezionati",
    ...
    "An error has occurred during your onboarding exam. Please retry onboarding.": "Si \u00e8 verificato un errore durante l'esame di onboarding. Riprovare l'onboarding. ",
    ...
    "Approved in Another Course": "Approvato in un altro corso ",
    "April": "Aprile",
    ...
    "Are you sure you want to leave this page? \nTo pass your proctored exam you must also pass the online proctoring session review.": "Sei sicuro di voler lasciare questa pagina?\n Per superare l&#39;esame con supervisione devi superare anche la revisione della sessione di supervisione online.",
    "Are you sure you want to remove this student's exam attempt?": "Sei sicuro di voler rimuovere il tentativo di esame di questo studente?",
    ...
    "Are you sure you want to resume this student's exam attempt?": "Sei sicuro di voler riprendere il tentativo di esame di questo studente?",
    ...
    "Change Session": "Modifica sessione ",
    ...
    "Click to copy link to clipboard": "Cliccare per copiare il collegamento negli appunti",
    ...
    "Copy Unit": "Unit\u00e0 di copia",
    "Copy link": "Copia il link",
    "Copy of \"{componentDisplayName}\"": "Copia di &quot;{componentDisplayName}&quot;",
    "Copy row": "Copia riga",
    ...
    "Discussion Configuration": "Configurazione della discussione",
    ...
    "Discussions enabled": "Discussione abilitata",
    "Dismiss": "Chiudi",
    ...
    "Editor": "Editore",
    "Edits made here will only be reflected in this course. These edits may be overridden later if updates are accepted.": "Le modifiche apportate qui verranno applicate solo a questo corso. Queste modifiche potranno essere ignorate in seguito se gli aggiornamenti saranno accettati.",
    "Eligible": "Idoneo",
    "Email": "Email",
    "Email address": "Indirizzo Email",
    "Email was sent to the following users. They will be allowed to enroll once they register:": "L&#39;email \u00e8 stata inviata ai seguenti utenti. Potranno registrarsi una volta completata la registrazione:",
    "Email was sent to the following users. They will be enrolled once they register:": "L&#39;email \u00e8 stata inviata ai seguenti utenti. Saranno iscritti al momento della registrazione:",
    ...
    "Embed": "Incorpora",
    "Embed Link": "Incorpora il collegamento",
    "Embed your subsection content directly on a page using an iframe, and view it without the LMS header and footer.": "Incorpora il contenuto della tua sottosezione direttamente in una pagina utilizzando un iframe e visualizzalo senza l&#39;intestazione e il pi\u00e8 di pagina LMS.",
    "Emoticons": "Emoticon",
    "Enable": "Abilita",
    ...
    "Enable summaries": "Attiva riepiloghi",
    "Enabled": "Abilitato",
    "Encoding": "Codifica",
    ...
    "Error": "Errore",
    "Error Ending Exam": "Errore durante la conclusione dell&#39;esame",
    "Error Starting Exam": "Errore durante l&#39;avvio dell&#39;esame",
    ...
    "Error generating list of inactive students who are enrolled in a course. Please try again.": "Errore durante la generazione dell&#39;elenco degli studenti inattivi iscritti a un corso. Riprova.",
    ...
    "Expired": "Scaduto",
    "Expiring Soon": "Prossimo alla scadenza ",
    ...
    "Hidden in the course outline, but sections are accessible for your learners through their separate link.": "Nascosto nella struttura del corso, ma le sezioni sono accessibili ai tuoi studenti tramite il loro collegamento separato.",
    ...
    "Hide in Course Outline, accessible via Link": "Nascondi nella struttura del Corso, accessibile tramite Link",
    ...
    "If you make this section visible in the table of content, learners will be able to see its content.": "Se rendi visibile questa sezione nel sommario, gli studenti potranno vederne il contenuto.",
    ...
    "It is intentionally hidden from learners, ensuring that only the course staff can view its contents.": "\u00c8 intenzionalmente nascosto agli studenti, garantendo che solo il personale del corso possa visualizzarne i contenuti.",
    "It is intentionally hidden from standard navigation, ensuring that only individuals with the link can view its contents.": "\u00c8 intenzionalmente nascosto dalla navigazione standard, garantendo che solo le persone con il collegamento possano visualizzarne il contenuto.",
    ...
    "It is visible to learners, ensuring that all learners can view its contents.": "\u00c8 visibile agli studenti, garantendo che tutti gli studenti possano visualizzarne il contenuto.",
    "Italic": "Corsivo",
    ...
    "Learners do not see question-level correctness or scores before or after the due date. However, once the due date passes, they can see their overall score for the subsection on the Progress page.": "Gli studenti non vedono la correttezza delle risposte o i punteggi a livello di domanda prima o dopo la data di scadenza. Tuttavia, una volta superata la data di scadenza, possono vedere il loro punteggio complessivo per la sottosezione nella pagina dei Progressi.",
    ...
    "Middle": "Al centro",
    "Midnight": "Mezzanotte",
    "Migrating to Problem Bank": "Migrazione alla Banca dei Problemi",
    ...
    "Never show individual assessment results, but show overall assessment results after due date": "Non mostrare mai i risultati delle valutazioni individuali, ma mostra i risultati complessivi delle valutazioni dopo la data di scadenza.",
    ...
    "New file(s) added to Files & Uploads.": "Nuovi file aggiunti a File e caricamenti.",
    ...
    "No ID Professional": "Nessun professionista dell&#39;identit\u00e0",
    ...
    "Onboarding Reset Failed Due to Past Due Exam": "Reimpostazione dell&#39;onboarding non riuscita a causa di un esame scaduto",
    "Onboarding Started": "Iniziato l&#39;onboarding",
    ...
    "Paste": "Incolla",
    "Paste %(xblock_type)s": "Incolla %(xblock_type)s",
    ...
    "Please enable discussions for graded units from the": "Si prega di abilitare le discussioni per le unit\u00e0 classificate dal sistema.",
    ...
    "Preview changes to: {title}": "Anteprima modifiche a: {title}",
    ...
    "Setup Started": "Installazione avviata",
    "Share": "Condividi",
    "Share Alike": "Condividi allo stesso modo",
    "Share {display_name} subsection": "Condividi la sottosezione {display_name}",
    ...
    "Showing first response": [
      ...
      "Mostrando le prime {numResponses} risposte",
      "Mostrando le prime {numResponses} risposte"
    ],
    ...
    "Something has gone wrong ending your exam. Please double-check that the application is running.": "Qualcosa \u00e8 andato storto durante la conclusione dell&#39;esame. Ti invitiamo a verificare che l&#39;applicazione sia in esecuzione.",
    "Something has gone wrong ending your exam. Please reload the page and start again.": "Qualcosa \u00e8 andato storto durante la conclusione dell&#39;esame. Ricarica la pagina e ricomincia.",
    "Something has gone wrong starting your exam. Please double-check that the application is running.": "Qualcosa \u00e8 andato storto durante l&#39;inizio dell&#39;esame. Ti invitiamo a verificare che l&#39;applicazione sia in esecuzione.",
    "Something has gone wrong starting your exam. Please reload the page and start again.": "Qualcosa \u00e8 andato storto durante l&#39;inizio dell&#39;esame. Ricarica la pagina e ricomincia.",
    ...
    "Subsections are not navigable between each other, they can only be accessed through their link.": "Le sottosezione non sono navigabili tra loro, \u00e8 possibile accedervi solo tramite il relativo link.",
    "Success": "Successo",
    ...
    "Successful completion of %(org)s %(program)s credential can be applied towards flexible, rigorous, and affordable masters degrees from the world\u2019s leading universities.": "Il completamento con successo delle credenziali %(org)s %(program)s pu\u00f2 essere applicato per master flessibili, rigorosi e convenienti dalle principali universit\u00e0 del mondo.",
    ...
    "The following files already exist in this course but don't match the version used by the component you pasted:": "I seguenti file esistono gi\u00e0 in questo corso ma non corrispondono alla versione utilizzata dal componente che hai incollato:",
    "The following information is already a part of your {platform} profile and is required for your application. To edit this information go to ": "Le seguenti informazioni fanno gi\u00e0 parte del tuo profilo {platform} e sono necessarie per la tua applicazione. Per modificare queste informazioni vai a ",
    ...
    "The following required files could not be added to the course:": "Non \u00e8 stato possibile aggiungere al corso i seguenti file obbligatori:",
    "The following required files were imported to this course:": "I file seguenti file obbligatori sono stati importati in questo corso:",
    ...
    "The number of {type} assignments defined here does not match the current number of {type} assignments in the course:": "Il numero di {type} compiti definiti qui non corrisponde al numero corrente di {type} compiti nel corso:",
    "The number of {type} assignments in the course matches the number defined here.": "Il numero di compiti {type} nel corso corrisponde al numero definito qui.",
    ...
    "There are no assignments of this type in the course.": "Nel corso non sono previsti compiti di questo tipo.",
    ...
    "This field must not be blank": "Questo campo non deve essere vuoto",
    ...
    "This subsection is configured as \\\"%(gradingType)s\\\", which doesn't exist in the current grading policy.": "Questa sottosezione \u00e8 configurata come \\\"%(gradingType)s\\\", che non esiste nell'attuale politica di valutazione.",
    ...
    "Time Multiplier": "Moltiplicatore del tempo",
    ...
    "To hide the subsections and keep them accesible through links, you must adjust it from the section that contains them.": "Per nascondere le sottosezioni e mantenerle accessibili tramite link, \u00e8 necessario regolarle dalla sezione che le contiene.",
    ...
    "Topics": "Argomenti",
    "Topics for unpublished units would not be created": "Gli argomenti per le unit\u00e0 non pubblicate non verrebbero creati",
    "Total": "Totale",
    "Total Number": "Numero totale",
    "Total Responses": "Numero totale di risposte ",
    "Track and plan your progress through the %(count)s course(s) in this program. To complete the program, you must earn a verified certificate for each course.": "Tieni traccia e pianifica i tuoi progressi attraverso i corsi %(count)s in questo programma. Per completare il programma, devi ottenere un certificato verificato per ogni corso.",
    ...
    "Transform your %(org)s %(type)s into a full master\u2019s degree": "Trasforma il tuo %(org)s %(type)s in un master completo",
    ...
    "Video ID": "Video ID",
    "Video Sharing": "Condivisione video",
    ...
    "View files": "Visualizza i file",
    "View in Library": "Visualizza nella libreria",
    ...
    "Visible to learners": "Visibile agli studenti",
    ...
    "What's in my clipboard?": "Cosa c'\u00e8 nei miei appunti?",
    ...
    "When sharing this link with your learners, they will see the content of the subsection along with the header and footer of your LMS.": "Quando condividi questo collegamento con i tuoi studenti, vedranno il contenuto della sottosezione insieme all&#39;intestazione e al pi\u00e8 di pagina del tuo LMS.",
    ...
    "Words: {0}": "Parole: {0}",
    "Would you like to permanently ignore this updated version? If so, you won't be able to update this until a newer version is published (in the library).": "Vuoi ignorare definitivamente questa versione aggiornata? In tal caso, non potrai aggiornarla finch\u00e9 non verr\u00e0 pubblicata una versione pi\u00f9 recente (nella libreria).",
    ...
    "Xpert unit summaries": "Riepiloghi delle unit\u00e0 Xpert",
    ...
    "You are editing content from a Library.": "State modificando contenuto di una libreria.",
    ...
    "You have access to the {enterpriseName} dashboard": "Hai accesso alla dashboard {enterpriseName}",
    ...
    "You have not started your onboarding exam.": "L'esame di onboarding non \u00e8 stato iniziato. ",
    ...
    "You have started your onboarding exam.": "L'esame di onboarding \u00e8 stato iniziato. ",
    "You have submitted your onboarding exam.": "Il tuo esame di onboarding \u00e8 stato inoltrato. ",
    "You have successfully completed all the requirements for the %(title)s %(type)s.": "Avete completato con successo tutti i requisiti per %(title)s %(type)s.",
    ...
    "You may also lose access to verified certificates and other program credentials. You can make a copy of these for your records before proceeding with deletion.": "Potresti anche perdere l'accesso ai certificati verificati e ad altre credenziali del programma. \u00c8 possibile farne una copia per i propri archivi prima di procedere con l'eliminazione.",
    ...
    "You may need to update a file(s) manually": "Potrebbe essere necessario aggiornare uno o pi\u00f9 file manualmente",
    ...
    "You must have at least one undroppable <%- types %> assignment.": "Devi avere almeno un compito <%- types %> non eliminabile.",
    ...
    "Your onboarding exam has been approved in another course.": "Il tuo esame di onboarding \u00e8 stato approvato in un altro corso.",
    "Your onboarding exam has been approved in this course.": "Il tuo esame di onboarding \u00e8 stato approvato in questo corso.",
    "Your onboarding exam has been rejected. Please retry onboarding.": "L'esame di onboarding \u00e8 stato rifiutato. Riprovare l'onboarding. ",
    "Your onboarding profile has been approved. However, your onboarding status is expiring soon. Please complete onboarding again to ensure that you will be able to continue taking proctored exams.": "Il tuo profilo di onboarding \u00e8 stato approvato. Tuttavia, il tuo stato di onboarding scadr\u00e0 a breve. Completa di nuovo l'onboarding per assicurarti di poter continuare a sostenere gli esami programmati.",
    "Your onboarding status has expired. Please complete onboarding again to continue taking proctored exams.": "Il tuo stato di onboarding \u00e8 scaduto. Completa di nuovo l&#39;onboarding per continuare a sostenere gli esami sorvegliati.",
    ...
    "Your question or idea (required)": "La tua domanda o idea (obbligatorio) ",
    ...
    "course id": "ID corso ",
    "course mode param is not provided": "il parametro della modalit\u00e0 corso non \u00e8 fornito",
    "course mode param is provided": "\u00e8 fornito il parametro della modalit\u00e0 corso",
    ...
    "query param next is internal": "il parametro query next \u00e8 interno",
    "query param next is provide": "il parametro query successivo \u00e8 fornito",
    ...
    "there is currently {numVotes} vote": [
      "attualmente c'\u00e8 {numVotes} voto",
      "attualmente ci sono {numVotes} voti",
      "attualmente ci sono {numVotes} voti"
    ],
    ...
    "{assignment_count} {type} assignment(s) found:": "{assignment_count} {type} compito trovati:",
    ...
    "{earned}/{possible} point (graded)": [
      "{earned}/{possible} punteggio (valutato)",
      "{earned}/{possible} punti (valutati)",
      "{earned}/{possible} punti (valutati)"
    ],
    "{earned}/{possible} point (ungraded)": [
      "{earned}/{possible} punto (non valutato)",
      "{earned}/{possible} punti (senza voto)",
      "{earned}/{possible} punti (senza voto)"
    ],
    "{email}": "{email}",
    ...
    "{numMoved} learner was moved from {prevCohort}": [
      "{numMoved} studenti sono stati spostati da {prevCohort}",
      "{numMoved} studenti sono stati spostati da {prevCohort}",
      "{numMoved} studenti sono stati spostati da {prevCohort}"
    ],
    "{numPreassigned} learner was pre-assigned for this cohort. This learner will automatically be added to the cohort when they enroll in the course.": [
      "Lo studente {numPreassigned} \u00e8 stato preassegnato a questo gruppo. Questo studente verr\u00e0 automaticamente aggiunto al gruppo quando si iscriver\u00e0 al corso.",
    ...
    "{numPresent} learner was already in the cohort": [
      "{numPresent} studente \u00e8 gi\u00e0 stato presente nella coorte",
      "{numPresent} studenti erano gi\u00e0 nel gruppo",
      "{numPresent} studenti erano gi\u00e0 nel gruppo"
    ],
    ...
    "{numUsersAdded} learner has been added to this cohort. ": [
      "{numUsersAdded} studenti sono stati aggiunti a questo gruppo. ",
    ...
    "{num_points} point possible (graded, results hidden)": [
      ...
      "{num_points} punti possibili (valutati, risultati nascosti)",
      "{num_points} punti possibili (valutati, risultati nascosti)"
    ],
    "{num_points} point possible (ungraded)": [
      "{num_points} punto possibile (non valutato)",
      "{num_points} punti possibili (senza valutazione)",
      "{num_points} punti possibili (senza valutazione)"
    ],
